...
@REM git push -f https://github.com/Shuaiwen-Cui/Research-Excitation_Structure_Response.git main
git push -f https://github.com/Shuaiwen-Cui/Research-Excitation_Structure_Response.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Research-Excitation_Structure_Response.git
